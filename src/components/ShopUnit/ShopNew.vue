<template>
  <div class="shopHomePage_container" >
    ...
    <div class="content" >
      <ShopHeadBar ref="ShopHeadBar" id="ShopHeadBar" :shopGuide_active_mark="3" class="ShopHeadBar"></ShopHeadBar>
      <div class="recomGoodContainer" :style="recomGoodContainerTopPos">
        <span class="dateofUpdate">
          7月20日
        </span>
            ...
            recommendedGoodsCpnStyle: {
                ...
                default() {
                    return {
                        ...
                        // 设置一个商品的宽度
                        item_style: 'width: 91.5%; border-radius: 10px',
                        // 设置是否显示店铺类型
